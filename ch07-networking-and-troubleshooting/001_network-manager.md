The **Network Manager** in Linux systems can be managed using (1) the Graphical Tool - if a Graphical Desktop Environment is installed, (2) the command-line tool **nmcli**, and (3) the text-based user interface **nmtui**. </br>  
