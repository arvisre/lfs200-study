The **Network Manager** in Linux systems can be managed using (1) the Graphical Tool - if a Graphical Desktop Environment is installed, (2) the command-line tool **nmcli**, and (3) the text-based user interface **nmtui**, and by executing the command **nm-connection-editor** that opens a Graphical Tool. </br>  
<img width="808" height="539" alt="Screenshot From 2026-07-01 00-04-02" src="https://github.com/user-attachments/assets/8c90bfcf-2dae-4d53-8545-ce67ff7c9269" /> </br>  
Having worked in Windows environments, **nmtui** is similar to the **sconfig** utility present in Windows Server Core. </br>  
<img width="517" height="451" alt="Screenshot From 2026-06-28 22-08-18" src="https://github.com/user-attachments/assets/af638b7e-5f9e-409a-8696-190b16a06698" /></br>  
